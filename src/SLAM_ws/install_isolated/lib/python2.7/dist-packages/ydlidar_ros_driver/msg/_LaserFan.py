...
"""autogenerated by genpy from ydlidar_ros_driver/LaserFan.msg. Do not edit."""
import sys
...
class LaserFan(genpy.Message):
  _md5sum = "be4554a7f739c3325c744fb261ecf7eb"
  _type = "ydlidar_ros_driver/LaserFan"
...
string frame_id
"""
  __slots__ = ['header','angle_min','angle_max','time_increment','scan_time','range_min','range_max','angles','ranges','intensities']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,angle_min,angle_max,time_increment,scan_time,range_min,range_max,angles,ranges,intensities
    ...
    """
    if args or kwds:
      super(LaserFan, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6f().pack(_x.angle_min, _x.angle_max, _x.time_increment, _x.scan_time, _x.range_min, _x.range_max))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.angle_min, _x.angle_max, _x.time_increment, _x.scan_time, _x.range_min, _x.range_max,) = _get_struct_6f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
